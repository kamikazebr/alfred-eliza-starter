...
export class WalletProvider {
    ...
    chains: Record<string, Chain> = { mainnet: viemChains.mainnet, base: viemChains.base };
    ...
    async getTokenBalance(tokenAddress: string): Promise<string> {
        const balance = await this.alchemy.core.getTokenBalances(this.account.address, [tokenAddress.toLowerCase()]);
...
export const evmWalletProvider: Provider = {
    async get(
        ...
        try {
            ...
            return `WalletInfo:\n User Wallet Address: ${address}\n ETH Balance: ${balance} ${chain.nativeCurrency.symbol}\nChain ID: ${chain.id}, Name: ${chain.name}`;
        } catch (error) {
